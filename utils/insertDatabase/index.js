...
// 1.批量插入首页banner数据(对应xidi数据库homebanner表)
// let homebanner = fs.readdirSync(`../../public/homepage/image/bannerImg`);
// let insertSqlArray = [];
// homebanner.map((item, index) => {
//   let obj = [];
//   obj.push(null);
//   obj.push(`../../public/homepage/image/bannerImg/${item}`);
//   insertSqlArray.push(obj);
// });
// let sql = "insert into homebanner(`id`,`imgUrl`) values ?";
// pool.query(sql, [insertSqlArray], (err, result) => {
//   if (err) {
//     console.log(err);
//   } else if (result.affectedRows > 0) {
//     console.log(`首页轮播图数据库导入数据成功！`);
//   }
// });
